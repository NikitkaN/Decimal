...
START_TEST(s21_is_greater_8) {
  s21_decimal value_1 = {{MAX_BITS, MAX_BITS, MAX_BITS, 0}};
  s21_decimal value_2 = {{MAX_BITS, MAX_BITS, 4294967294, 0}};
...
START_TEST(s21_add_11) {
  s21_decimal value_1 = {{MAX_BITS, MAX_BITS, MAX_BITS, 0}};
  setsigns(&value_1, 1);
  s21_decimal value_2 = {{MAX_BITS, MAX_BITS, MAX_BITS, 0}};
  s21_decimal result;
  s21_decimal check = {{0, 0, 0, 0}};
  int return_value = s21_add(value_1, value_2, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
...
START_TEST(s21_sub_8) {
  ...
  s21_decimal value_2 = {{1, 0, 0, 0}};
  s21_decimal result;
  s21_decimal check = {{MAX_BITS, 0, 0, 0}};
  int return_value = s21_sub(value_1, value_2, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, OK);
}
...
START_TEST(s21_from_decimal_to_float_2) {
  s21_decimal value = {{MAX_BITS, 0, MAX_BITS, 0}};
  set_scale(&value, 29);
  float a = 0, b;
  int res = s21_from_decimal_to_float(value, &b);
  ck_assert_float_eq(a, b);
  ck_assert_int_eq(res, CONVERTING_ERROR);
}
END_TEST
